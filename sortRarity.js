...
function sendBatchRequest(){
            ...
            if (this.status === 200) {
                ...
                for (let i=0; i<result.length; i++){
                    ...
                    text.textContent = "Token ID: " + (result[i]["tokenDetails"]["tokenId"]) +
                        ", Rarity Score: " + Math.round(result[i]['rarityScore'] * 100) / 100
                ...
                if (skip === 0){
                    ...
                    nextButton.style.marginLeft = "125px"
                    ...
                    beforeButton.style.marginLeft = "90px"
                    ...
                    beforeButton.innerHTML = "Before"
                    beforeButton.onclick = sendBatchRequestBefore
                    beforeButton.style.marginLeft = "125px"
                    page.appendChild(beforeButton)
                }
            }
        }
    ...
    request.open("POST", "/sortRarityData", true);
